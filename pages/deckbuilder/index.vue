                ...
                <template>
                  <v-dialog persistent max-width="290" v-model="dialog">
                    <template v-slot:activator="{ on, attrs }">
                      ...
                      <v-btn color="error darken-2" class="ma-2"
                        >Delete deck</v-btn
                      >
                      <v-btn
                        color="primary"
          ...
          <v-card elevation="2" class="card-deck">
            <div v-if="selectedDeck !== null">
              ...
              <h2 v-if="deck.main.length !== 0">
                <v-badge color="amber darken-1" :content="deck.main.length"
                  >Main Deck</v-badge
                >
              </h2>
              ...
              <h2 v-if="deck.extra.length !== 0">
                <v-badge color="black" :content="deck.extra.length"
                  >Extra Deck</v-badge
                >
              </h2>
              ...
              <h2 v-if="deck.side.length !== 0">
                <v-badge color="amber darken-1" :content="deck.side.length"
                  >Side Deck</v-badge
                >
              </h2>
