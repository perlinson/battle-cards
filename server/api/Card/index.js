...
const { name, type, desc, atk, def, level, race, attribute, card_images, card_prices, game } = schema.tree
 ...
 */
router.post('/',
  body({ name, type, desc, atk, def, level, race, attribute, card_images, card_prices, game }),
  create)
